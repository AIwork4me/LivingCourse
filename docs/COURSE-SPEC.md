...
`COURSE_SPEC_VERSION` is independent of npm package versions. Migration steps are pure, contiguous and deterministic. Missing migration paths fail loudly, and migrating an already-current document is idempotent.
